...
class ChannelsApi
{
     ...
     *
     * @param  string $channel_id Channel&#39;s id (required)
     * @param  string $reason_code The reason code for hanging up the channel for detail use. Mutually exclusive with &#39;reason&#39;. See detail hangup codes at here. https://docs.asterisk.org/Configuration/Miscellaneous/Hangup-Cause-Mappings/ (optional)
